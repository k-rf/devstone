---
description: >-
  プロジェクトにおける命名規則と、一貫した用語の使用方法を定義します。
trigger: always_on
---
...
- **Repository**: `core/port/repository/xyz.repository.ts`
